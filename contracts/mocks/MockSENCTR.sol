...
/**
 * A mock version of sENCTR, with an over-simplified rebase mechanism, for testing purposes only
 */
contract MockSENCTR is ERC20 {
    ...
    constructor(uint256 initialIndex_, uint256 rebasePct_) ERC20("Mock sENCTR", "sENCTR") {
